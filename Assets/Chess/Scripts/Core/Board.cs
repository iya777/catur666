...
public class Board {
	...
	public int ColourToMove { get; set; }
	public int OpponentColour { get; set; }
	...
	public uint currentGameState { get; set; }

    public int plyCount { get; set; } // Total plies played in game
    public int fiftyMoveCounter { get; set; } // Num ply since last pawn move or capture

    public ulong ZobristKey { get; set; }
    /// List of zobrist keys 
    public Stack<ulong> RepetitionPositionHistory { get; set; }

    public int[] KingSquare { get; set; } // index of square of white and black king
